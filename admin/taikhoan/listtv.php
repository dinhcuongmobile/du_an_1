                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <?php
                            foreach ($listtk as $tk) {
                                ...
                                echo '<tr>
                                        <td class="align-middle text-center"><input type="checkbox" name="select[]" value="'.$id.'"></td>
                                        ...
                                        <td class="col-2 align-middle text-center"><a href="?act=updatetk&id='.$id.'"><button type="button" class="btn btn-secondary btn-sm">Sửa</button></a> | 
                                            <a href="?act=xoatk&id='.$id.'"><button type="button" class="btn btn-secondary btn-sm">Xóa</button></a></td>
                                    </tr>';
                            }
                            ?>  
                        </tbody>
