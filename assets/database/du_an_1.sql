...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 17, 2023 lúc 10:50 AM
...
CREATE TABLE `donhang` (
  `id` int(5) NOT NULL,
  `idtaikhoan` int(5) NOT NULL DEFAULT 0,
  `hovaten` varchar(255) NOT NULL,
  `diachi` varchar(255) NOT NULL,
  `sodienthoai` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phuongthuctt` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0. thanh toán trực tiếp 1. Chuyển khoản ',
  `ngaydathang` varchar(50) DEFAULT NULL,
  `tongtien` int(10) NOT NULL DEFAULT 0,
  `trangthai` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0. Đang chờ duyệt 1. Đã duyệt',
  `tennguoinhan` varchar(50) DEFAULT NULL,
  `diachinhan` varchar(255) DEFAULT NULL,
  `sodienthoainhan` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `donhang` (`id`, `idtaikhoan`, `hovaten`, `diachi`, `sodienthoai`, `email`, `phuongthuctt`, `ngaydathang`, `tongtien`, `trangthai`, `tennguoinhan`, `diachinhan`, `sodienthoainhan`) VALUES
(1, 4, 'Nguyễn Viết Sơn', 'Hà Nội', '0123456789', 'nguyenvietson@gmail.com', 1, '2023-10-03 21:50:24', 10000000, 0, NULL, NULL, NULL);
...
INSERT INTO `giohang` (`id`, `idtaikhoan`, `idsanpham`, `image`, `tensp`, `giasp`, `soluong`, `thanhtien`, `idbill`) VALUES
(1, 4, 1, '1.webp', 'iPhone 14 Pro 128GB | Chính hãng VN/A', 24590000, 1, 24590000, 1);
...
--
ALTER TABLE `donhang`
  ADD CONSTRAINT `fk_bill_tk` FOREIGN KEY (`idtaikhoan`) REFERENCES `taikhoan` (`id`);

--
-- Các ràng buộc cho bảng `giohang`
--
ALTER TABLE `giohang`
  ADD CONSTRAINT `fk_cart_bill` FOREIGN KEY (`idbill`) REFERENCES `donhang` (`id`),
